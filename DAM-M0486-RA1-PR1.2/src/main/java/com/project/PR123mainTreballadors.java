...
public class PR123mainTreballadors {
    ...
    public void mostrarTreballadors() throws IOFitxerExcepcio {
        // *************** CODI PRÀCTICA **********************/
        List<String> treballadorsCVS = llegirFitxerCSV();
        System.out.println("Lista trebalaldors");
        UtilsCSV.llistar(treballadorsCVS);
    }
    ...
    public void modificarTreballador(String id, String columna, String nouValor) throws IOFitxerExcepcio {
        // *************** CODI PRÀCTICA **********************/
        List<String> treballadorsCVS = llegirFitxerCSV();
        int linea = UtilsCSV.obtenirNumLinia(treballadorsCVS, "Id", id);
        if (linea == -1){
            throw new IOFitxerExcepcio("Trballador no trobat");
        }
        UtilsCSV.actualitzarLinia(treballadorsCVS, linea, columna, nouValor);
        escriureFitxerCSV(treballadorsCVS);
    }
